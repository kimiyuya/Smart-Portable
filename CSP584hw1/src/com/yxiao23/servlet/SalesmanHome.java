        ...
        if (request.getParameter("customer") != null && request.getParameter("customer").equals("Create Customer")) {
            ...
            if (!password.equals(repassword)) {
                ...
                if (hm.containsKey(username)) {
                    ...
                    FileOutputStream fileOutputStream = new FileOutputStream(TOMCAT_HOME + "//wtpwebapps//CSP584hw1//UserInfo.txt");
...
//		pw.print("</h2><div class='entry'>");
//		
//		pw.print("<h2><form  action='AddOrder' method='post'></h2>");
...
//
//		
//		for (Map.Entry<Integer, ArrayList<OrderPayment>> entry : paymentList.entrySet()) {
//            for (OrderPayment od : entry.getValue()) {
...
//                 
//                 pw.print("<td><input type='submit' name='Order' value='Update' class='btnbuy'></td>");
////                 pw.print("<form method='post' action='RemoveOrder'>");
////                 pw.print("<input type='hidden' name='orderId' value='" + od.getOrderId() + "'>");
