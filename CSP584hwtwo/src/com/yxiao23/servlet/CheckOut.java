...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (OrderItem oi : utility.getCustomerOrders()) 
		{
			...
			pw.print(oi.getProductName()+"</td></tr><tr><td>");
			...
			pw.print("Product Price:</td><td>"+ oi.getProductPrice());
			pw.print("</td></tr>");
		}
		pw.print("<tr><td>");
		...
		pw.print("<tr><td>");
     	pw.print("Recipient Name:</td>");
		pw.print("<td><input type='text' name='recipientName'>");
		pw.print("</td></tr>");
		pw.print("<tr><td>");
